  ...
  return (
    <section className="py-20 container">
      ...
      <div className="grid grid-cols-12 grid-rows-2 gap-10">
        <div className="col-start-1 col-end-8 rounded-3xl row-span-2 bg-gray-900 flex flex-col p-14 justify-between items-start">
          ...
          <button className="flex-center text-pink-200">
            <div className="border-pink-200 rounded-full p-2 border inline-block mr-5">
              <FiArrowUpRight className="w-7 h-7" />
            </div>
            Start
          </button>
        </div>
        <div className="col-start-8 col-end-13 rounded-3xl row-start-1 row-end-1 bg-white flex items-center border-2 border-gray-900 px-10 py-8">
